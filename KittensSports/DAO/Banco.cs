...
namespace KittensSports.DAO
{
    ...
    public class Banco
    {
        private static string _strCon = @"sData Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Patrick\Documents\vsf\KittensSports\DAO\banco.mdf;Integrated Security=True";
