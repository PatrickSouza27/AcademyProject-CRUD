...
namespace KittensSports.DAO
{
    ...
    public class Banco
    {
        private static string _strCon = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\patrick.souza1\Documents\vsf\KittensSports\DAO\banco.mdf;Integrated Security=True";
