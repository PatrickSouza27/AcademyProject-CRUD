...
namespace KittensSports.DAO
{
    ...
    public class Banco
    {
        private static string _strCon = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\Users\Usuario\Downloads\KittensSports2 (1)\KittensSports2\KittensSports\KittensSports\DAO\banco.mdf"";Integrated Security=True";
